    ...
    cifras: [
      {
        ...
        nota: "Suplementos, indumentaria, cosmética, formación y también servicios. Muchas siguen vendiendo hoy.",
      },
      {
        n: 130,
        prefix: "+",
        label: "MARCAS Y PRODUCTOS",
        nota: "Muchos clientes prueban varias marcas por vez. Ese es el ritmo con el que trabajo.",
      },
      {
        n: 25,
        prefix: "",
        label: "MILLONES EN UN DÍA",
        nota: "Lo que facturó uno de mis lanzamientos en una sola jornada. Validó el primer día y el producto sigue vendiéndose hoy.",
      },
    ],
