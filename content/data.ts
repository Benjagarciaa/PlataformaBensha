  ...
  proyectos: {
    ...
    items: [
      ...
      },
      {
        ...
        rubro: "SUPLEMENTOS",
        descripcion:
          "Página editorial larga con estructura de advertorial: arranca por el problema, sigue por lo que ya probó y no funcionó, y recién ahí aparece el producto. El copy es tan importante como el diseño.",
        bloques: ["Advertorial", "Testimonios", "Bundles", "Barra fija"],
      ...
      },
      {
        ...
        rubro: "COSMÉTICA",
        descripcion:
          "Identidad visual completa para una marca de medicina ayurvédica: paleta marrón y dorada, tipografía propia y todas las imágenes de producto generadas con IA, sin sesión de fotos.",
        bloques: ["Identidad visual", "Imágenes IA", "Antes y después", "FAQ"],
      ...
      },
      {
        ...
        rubro: "SUPLEMENTOS",
        descripcion:
          "Fichas técnicas y sellos de certificación rearmados en español para el mercado argentino: tabla nutricional, modo de uso y garantías de calidad, con el mismo nivel de terminación que el original.",
        bloques: ["Ficha técnica", "Sellos", "Modo de uso", "Bundles"],
